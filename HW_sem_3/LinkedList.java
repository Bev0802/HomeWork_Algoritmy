...
public class LinkedList {
    ...
    */    
    ...
    private void revert(Node currantNode, Node previousNode){
        if (currantNode.next == null) {
            head = currantNode;
        } else {
            revert(currantNode.next , currantNode);
        }
        currantNode.next = previousNode;
        previousNode.next = null;
    }


    /**
     * @param value добавление переменной в список.
     */
